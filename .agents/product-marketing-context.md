...
| Site | Domain | Niche |
|------|--------|-------|
| Murrieta Tree Service | treeservice-murrieta.com | Tree removal, trimming, stump grinding, emergency |
| Murrieta Landscaping | landscaping-murrieta.com | Landscape design, lawn care, irrigation, cleanup |
