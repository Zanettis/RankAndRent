---
title: "How to Prepare Your Lawn for Murrieta's Dry Season"
description: "Murrieta's summer dry season is brutal on lawns. Here's a step-by-step guide to preparing your grass for the heat — and keeping it green without wasting water."
pubDate: 2025-05-03
author: "Murrieta Landscaping Pros"
tags: ["lawn care", "murrieta", "dry season", "summer lawn", "water restrictions"]
featured: false
howToSteps:
  - name: "Aerate to combat clay soil compaction"
    text: "Use core aeration (not spike aeration) to remove soil plugs and create channels for water, air, and nutrients to reach root depth. In Murrieta's clay soils, compaction is severe — aerate fescue in February–March, bermuda in May–June."
  - name: "Dethatch if the thatch layer exceeds half an inch"
    text: "Pull a small turf plug and measure the brown layer between green grass and soil. If it exceeds about half an inch, use a power rake or dethatch machine before the dry season. Bermuda benefits from dethatching every 2–3 years."
  - name: "Fertilize strategically with slow-release nitrogen"
    text: "Apply a slow-release balanced fertilizer in early spring to build root mass and density without pushing excessive top growth. For fescue, fertilize in late February or March. Avoid high-nitrogen fertilizer after May — it demands more water during the heat."
  - name: "Optimize your irrigation schedule for deep, infrequent watering"
    text: "Water deeply to saturate soil to 6–8 inches, then let it partially dry before the next cycle. Comply with EVMWD and RCWD time-of-day rules (before 9 AM or after 6 PM). Walk your system while it runs to check for broken heads and coverage gaps."
  - name: "Raise your mowing height to shade the soil surface"
    text: "Taller grass shades the soil, reducing surface temperature and evaporation. Set tall fescue to 3–3.5 inches for summer; bermuda to 1.5–2 inches. Never remove more than one-third of the blade in a single mow, and keep blades sharp."
  - name: "Edge and clean borders to reduce competition for water"
    text: "Overgrown edges and weedy borders compete with turf for water and nutrients during the dry season. Define clean edges between lawn and planting beds, and remove weeds from borders before summer heat arrives."
---
